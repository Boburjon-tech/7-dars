...
let D_ = +prompt("kunni kiriting:");
let M_ = +prompt("oyni kiriting:");

switch (M_) {
    case 1: M_="yanvar";break;
    case 2: M_="Fevral";break;
    case 3: M_="Mart";break;
    case 4: M_="Aprel";break;
    case 5: M_="May";break;
    case 6: M_="Iyun";break;
    case 7: M_="Iyul";break;
    case 8: M_="Avgust";break;
    case 9: M_="Sentabr";break;
    case 10: M_="Oktyabr";break;
    case 11: M_="Noyabr";break;
    case 12: M_="Dekabr";break;
    default:false;break;
}

if (D_==31 && M_==2 ||M_==4||M_==6||M_==9||M_==11){
    false;
}
else if (D_>28 && M_=="Fevral"){
...
} else if(D_==31 && M_==1||M_==3||M_==5||M_==7||M_==8||M_==10||M_==12){
    D_=1;
    M_+=1;
    console.log(`${D_}-${M_}`);
} else if (D_==30 && M_==2||M_==4||M_==6||M_==9||M_==11){
    D_=1;
    M_+=1;
    console.log(`${D_}-${M_}`);
}else {
